...
"%JAVA_HOME%\bin\java.exe" %JVM_OPTS% %JMX_MON% -DGRIDGAIN_HOME="%GRIDGAIN_HOME%" -DGRIDGAIN_PROG_NAME="%PROG_NAME%" -cp "%CP%;." org.gridgain.grid.groovy.examples.helloworld.gridify.basic.GridifyHelloWorldGroovyBasicExample "%CONFIG%"
