...
"${JAVA_HOME}/bin/java" ${JVM_OPTS} ${JMX_MON} -DGRIDGAIN_HOME="${GRIDGAIN_HOME}" -DGRIDGAIN_PROG_NAME="$0" -cp "${CP}:." org.gridgain.grid.groovy.examples.helloworld.gridify.basic.GridifyHelloWorldGroovyBasicExample "${CONFIG}"
