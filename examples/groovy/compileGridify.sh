...
${GROOVY_HOME}/bin/groovyc -cp ${GRIDGAIN_HOME}/${ANT_AUGMENTED_GGJAR} ./org/gridgain/grid/groovy/examples/helloworld/gridify/basic/GridifyHelloWorldGroovyBasicExample.groovy
